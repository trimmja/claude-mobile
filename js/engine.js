...
export function doAction(actionId) {
  ...
  hooks.onActionComplete?.({ id: result.id, bonuses: result.bonuses, beat: result.beat, reward: result.reward, timeSpent: result.timeSpent, energySpent: result.energySpent });
